...
//zou
#define HostAddress   @"http://test.yewyw.com" //测试服务器
//#define HostAddress   @"http://api.yewyw.com"  //正式服务器

#define SYSCOLOR_LINE [UIColor colorWithRed:220.0/255.0 green:220.0/255.0 blue:220.0/255.0 alpha:1.00]
#define IS_IPHONE_5 ( fabs( ( double )[ [ UIScreen mainScreen ] bounds ].size.height - ( double )568 ) < DBL_EPSILON )
#define sysDGrayColor [UIColor colorWithRed:150.0/255.0 green:150.0/255.0 blue:150.0/255.0 alpha:1.00];
#define SystemGreenColor   RGBACOLOR(0, 201, 68, 1)
#define SystemGrayColor    RGBACOLOR(150, 150, 150, 1)
#define RGBACOLOR(r,g,b,a) [UIColor colorWithRed:(r)/255.0 green:(g)/255.0 blue:(b)/255.0 alpha:(a)]

#define KNOTIFICATION_LOGINCHANGE @"loginStateChange"

#define CHATVIEWBACKGROUNDCOLOR [UIColor colorWithRed:0.936 green:0.932 blue:0.907 alpha:1]
#define SYSNAVGETION_COLOR [UIColor colorWithRed:49.0/255.0 green:195/255.0 blue:124.0/255.0 alpha:1.00]
