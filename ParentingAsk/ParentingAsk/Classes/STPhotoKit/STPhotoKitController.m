...
- (void)setSizeClip:(CGSize)sizeClip
{
    ...
    _rectClip = CGRectMake(0, 0, ScreenWidth, ScreenHeight);
}
...
- (UIButton *)buttonBack
{
    if (!_buttonBack) {
        ...
        CGFloat buttonX = ScreenWidth - buttonW - STMarginBig;
        CGFloat buttonY = ScreenHeight - buttonH - STMarginBig;
        _buttonBack = [[UIButton alloc]initWithFrame:CGRectMake(0, 0, ScreenWidth, ScreenHeight)];
        [_buttonBack setCenterX:buttonX/2];
