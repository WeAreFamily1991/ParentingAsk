...
+ (CellPersonInfo *)cellWithTableView:(UITableView *)tableView IndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell.btnEdit setBackgroundColor:[UIColor clearColor]];
...
+ (CellPersonInfo *)cellWithTableView:(UITableView *)tableView Index:(NSInteger)index
{
    ...
    switch (index) {
        case 0:
        {
            cell.labTitle = [[UILabel alloc] initWithFrame:CGRectMake(13.0, 12.0, 100.0, 20.0)];
            [cell.labTitle setText:@"个人简介"];
            [cell.labTitle setTextColor:[UIColor blackColor]];
        ...
        case 1:
        {
            ...
            [cell.btnExit setFrame:CGRectMake(18.0, 15.0, (ScreenWidth - 50.0), 40.0)];
