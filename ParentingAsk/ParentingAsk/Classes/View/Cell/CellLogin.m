...
{
    NSString *strIdenti = [NSString stringWithFormat:@"identiLoginVC%ld", (indexPath.row + 1)];
    ...
    [cell.textUsername.layer setBorderColor:[UIColor clearColor].CGColor];
    [cell.textUsername.layer setBorderWidth:0.5f];
    [cell.textUsername.layer setCornerRadius:3.0f];
    [cell.textUsername setKeyboardType:UIKeyboardTypeNumberPad];
...
//    [imageLeft setImage:[UIImage imageWithFile:@"name-gray.png"]];
//    [viewLeft addSubview:imageLeft];
//    [cell.textUsername setLeftView:viewLeft];
    
    [cell.textPassword.layer setBorderColor:[UIColor clearColor].CGColor];
...
//    [imageRight setImage:[UIImage imageWithFile:@"lock-gray.png"]];
