...
- (id)initWithMessageModel:(MessageModel *)model reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        [_headImageView addGestureRecognizer:[[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(clickHeadImage)]];
...
//    UIImage *placeholderImage = [UIImage imageNamed:@"chat-doctor-head"];
